 ...
 *         application/json:
 *           schema:
 *             $ref: "#/components/schemas/UpdateTermsConditionsRequest"
 *     responses:
 *       "200":
 *         description: Successful response
 *         content:
 *           application/json:
 *             schema:
 *               $ref: "#/components/schemas/UpdateTermsConditionsResponse"
 *       "401":
 *         description: Unauthorized
 *         content:
 *           application/json:
 ...
 *           type: string
 *         data:
 *           $ref: "#/components/schemas/TermsConditionsData"
 *
 *     TermsConditionsData:
 *       type: object
 *       properties:
...
/**
 * @openapi
 * /api/cms/about/add-carousel:
 *   post:
 *     summary: Add Carousel Images to About Us
 *     tags:
 *       - CMS
 *     requestBody:
 *       required: true
...
/**
 * @openapi
 * /api/cms/about/delete-carousel/{id}:
 *   delete:
 *     summary: Delete Specific Carousel Image from About Us
 *     tags:
 *       - CMS
 *     parameters:
 *       - in: path
