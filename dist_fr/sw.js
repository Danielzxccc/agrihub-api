...
se([{"revision":null,"url":"assets/index-31d44d75.css"},{"revision":"3e5776aec775b78bb3474e7e1048fc70","url":"index.html"},{"revision":"58dc9256a94ced172cea92ca533d50f0","url":"agrihub-logo-192-192.png"},{"revision":"e6e64bb3876cc0b4eb6374aaf073a339","url":"agrihub-logo-512-512.png"},{"revision":"090b8840e9b62b7dd86d72d7cd25c8ea","url":"manifest.webmanifest"}]);
self.addEventListener("push", (a) => {
  const e = a.data.json(), t = e.title, s = e.body, n = e.icon, r = e.data.url, c = {
    body: s,
    tag: "unique-tag",
    ...
    data: {
      url: r
      // Replace with the desired URL for redirecting user to the desired page
    }
  };
  self.registration.showNotification(t, c);
});
